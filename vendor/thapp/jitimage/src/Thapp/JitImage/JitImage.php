...
class JitImage
{
    ...
    {
        $this->mode = 'resize';
        $this->targetSize = array($width, $height);
    ...
    protected function callCrop($width, $height, $gravity, $background = null)
    {
        $this->mode = 'crop';
        $this->targetSize = array($width, $height);
        $this->arguments = array($gravity, $background);
    }
    ...
    protected function callScale($percent)
    {
        ...
        $this->targetSize = array($percent, null);
        $this->arguments = array();
    }
    ...
    protected function callPixel($pixel)
    {
        ...
        $this->targetSize = array($pixel, null);
        $this->arguments = array();
    }
    ...
    public function __call($method, $arguments)
    {
        if (method_exists($this, $m = sprintf('call%s', ucfirst($method)))) {
            call_user_func_array(array($this, $m), $arguments);
            return $this->process();
        }
