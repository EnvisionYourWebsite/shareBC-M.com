...
class RemoveDlLimitedLink extends Command
{
	 ...
	 * @var string
	 */
	protected $name = 'kotakin:removeDlLimitedLink';
	 ...
	 * @var string
	 */
	protected $description = 'Remove any download limit reached link and the file (optional).';
	...
	public function fire()
	{
		...
		$links = $this->getKotakin()->getDocLink()->newQuery()
					->whereRaw('`downloaded_times` = `limit`')
					->get();
